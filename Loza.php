...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
 ...
 <div class="example">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-sm-7 ftco-animate text-center">
              <h1 class="mb-4">LOS MEJORES EVENTOS ENCUENTRALOS CON NOSOTROS</h1>
              <h2 class="subheading">"10 AÑOS DE HISTORIA NOS RESPALDAN"</h2>
            </div>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h3 class="subheading">LOZA</h3>
            <h2 class="mb-1">"LA MEJOR LOZA DE LA ZONA"</h2>
          </div>
        </div>
  ...
  $sdb=mysqli_select_db($con,$db)or die("la base de datos no existe");
    ...
    $consulta = "SELECT * FROM productos where Tipo= 'Loza' ";
