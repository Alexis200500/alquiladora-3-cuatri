...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand py-4 px-6" href="index.html">AECN</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="Lonas.php" class="nav-link">Lonas</a></li>
            <li class="nav-item"><a href="Inflables.php" class="nav-link">Inflables</a></li>
            <li class="nav-item"><a href="Facturacion.php" class="nav-link">Factura</a></li>
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-sm-6 ftco-animate text-center">
              ...
              <h2 class="subheading">"10 AÑOS DE HISTORIAS NOS RESPALDAN"</h2>
            </div>
      ...
      <div class="slider-item js-fullheight" style="background-image: url(images/abc2.jpg);">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-sm-6 ftco-animate text-center">
              <h1 class="mb-4">"TUS MEJORES SRVICIOS ENCUENTRALOS CON NOSOTROS"</h1>
