...
<p>.</p>
    ...
    <MARQUEE><h1 ><p style="color:#FFffff"; >ALTA COMPRA </p> </h1></MARQUEE>
...
<table style="margin:0 auto;">
 <th>
  ...
  <form action="altacompra.php" method = "post" enctype="multipart/form-data">
    <fieldset>
      Id_cliente<br>
 ...
 <fieldset>
    ...
    <fieldset>
      Subtotal<br>
      <input type="text" name="sub"placeholder="Subtotal renta">
    </fieldset>
      Imagen<br>
      <input type="file" name="file"placeholder="Ingresar imagen">
    </fieldset>
...
<footer class="ftco-footer ftco-section img">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> EQUIPO 6 UTVT </i> by <a href="https://colorlib.com" target="_blank"></a>
