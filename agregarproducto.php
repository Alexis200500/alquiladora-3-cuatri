...
<table>
 ...
 <th>
	...
	<form action="altaproducto.php" method = "post" enctype="multipart/form-data">
		...
		<fieldset>
			Dimension<br>
			<input type="text" name="dimension"placeholder="Dimension/tamaño">
		</fieldset>
		<fieldset>
			Capacidad<br>
		...
		<fieldset>
			Presio<br>
			<input type="text" name="presio"placeholder="Costo/producto">
		</fieldset>
		<fieldset>
			Personaje<br>
			<input type="text" name="personaje"placeholder="personaje/producto">
		</fieldset>
		<fieldset>
			Imagen<br>
			<input type="file" name="file"placeholder="imagen del producto">
		</fieldset>
	
		<input type="submit" name="accion" value="Enviar" class="aceptar"placeholder="Enviar">
	</form>	
