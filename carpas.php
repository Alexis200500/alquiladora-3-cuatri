...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
 ...
 <div class="collapse navbar-collapse" id="ftco-nav">
      ...
      <ul class="menu">
         ...
         <li><a href="">Servicios</a>
          <ul class="submenu">
            ...
            <li><a href="Loza.php">Loza</a></li>
              <li><a href="Manteles.php">Manteleria</a></li>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h3 class="subheading">CARPAS</h3>
            <h2 class="mb-1">"LAS MEJORES CARPAS ELEGANTES DE LA ZONA"</h2>
          </div>
        </div>
  ...
  $sdb=mysqli_select_db($con,$db)or die("la base de datos no existe");
    ...
    $consulta = "SELECT * FROM productos where Tipo= 'Carpa' ";
        ...
        <div class="row">
          <div class="col-lg-3 promo ftco-animate">
            <div class="text text-center">
              <img src="productos/carpa4.jpg" width="200" height="150">;
              <h2>Paquetes Completo</h2>
              <h3 class="price"><span>Desde</span> $45000</h3>
              <a href="#" class="read">leer Mas</a>
            </div>
          </div>
          <div class="col-lg-3 promo ftco-animate">
            <img src="productos/carpa3.jpg" width="200" height="150">;
            <div class="text text-center">
              <h2>Paquete mediano</h2>
              <h3 class="price"><span>Desde</span> $25000</h3>
              <a href="#" class="read">Leer Mas</a>
            </div>
          </div>
          <div class="col-lg-3 promo ftco-animate">
             <img src="productos/carpa2.jpg" width="200" height="150">;
            <div class="text text-center">
              <h2>Paquete xv años</h2>
              <h3 class="price"><span>Desde</span> $15000</h3>
              <a href="#" class="read">Leer Mas</a>
            </div>
          </div>
          <div class="col-lg-3 promo ftco-animate">
      ...
      <div class="container-fluid">
        <div class="row mb-5 pb-5 no-gutters">
          <div class="col-lg-4 bg-light p-3 p-md-5 d-flex align-items-center heading-section ftco-animate">
            <div>
              <h2 class="mb-5 pb-3">¿Quieres obtener nuestras mejores ofertas de Paquetes Para Fiesta Suscríbete ahora!</h2>
