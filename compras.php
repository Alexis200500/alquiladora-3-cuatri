...
<link href="css/stacktable.css" rel="stylesheet">
 ...
 <p align="center"><h1 align="center">COMPRAS</h1></p>
...
//$Ide=$_GET['id'];
$consulta="SELECT c.numeroventa, cl.id_cliente,cl.nombre, cl.ap_paterno, cl.ap_materno, cl.email, c.nombre, c.precio, c.cantidad, c.subtotal FROM compras c , clientes cl WHERE c.id_cliente= cl.id_cliente";
    ...
    while ($row=mysqli_fetch_array($resultado)) {
        ...
        <tr>
          ...
          <td><input type="text" class="ap_paterno" value="'.$row[2].'"></td>
          <td><input type="text" class="ap_materno" value="'.$row[3].'"></td>
            <td><input type="text" class="email" value="'.$row[4].'"></td>
          <td><input type="text" class="nombre" value="'.$row[5].'"></td>
        <td><input type="text" class="precio" value="'.$row[6].'"></td>
        <td><input type="text" class="cantidad" value="'.$row[7].'"></td>
        <td><input type="text" class="subtotal" value="'.$row[8].'"></td>
...
<P>.</P>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> "ALQUILADORA CHONG" EQUIPO 6 UTVT </i> by <a href="https://colorlib.com" target="_blank"></a>
