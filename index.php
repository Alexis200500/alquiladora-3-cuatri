    		...
    		<div class="row d-flex align-items-center">
    			...
    			<div class="col-xl-6 align-self-stretch pt-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		          	<h3 class="subheading">ALQUILADORA CHONG</h3>
    				...
    				<div class="services d-flex ftco-animate">
							...
							<div class="text ml-5">
								<h3>Mision</h3>
								<p> Ofrecer los mejores servicios de alquiler para todo tipo de eventos sociales a toda la comunidad én general.  </p>
							</div>
  					</div>
  					<div class="services d-flex ftco-animate">
							<div class="icon d-flex justify-content-center align-items-center">
							...
							<div class="text ml-5">
								<h3>Vision</h3>
								<p>Ser la alquiladora  lider en el mercado, brindando servicios de alta calidad en la poblacion, generando valor a nuestra empresa, clientes, provedores y a nuestro equipo de trabajo.</p>
							</div>
  					</div>
  					<div class="services d-flex ftco-animate">
							<div class="icon d-flex justify-content-center align-items-center">
							...
							<div class="text ml-5">
								<h3>Compromiso</h3>
								<p>A.E.C.N tiene como compromiso lograr que el cliente quede satisfecho con nuestros servicios.</p>
							</div>
  					</div>
  					<div class="services d-flex ftco-animate">
							<div class="icon d-flex justify-content-center align-items-center">
							...
							<div class="text ml-5">
								<h3>valores</h3>
								<ol type="A">
                  <li>Calidad en los servicios</li>
                  <li>Servicio y atencion durante la cotizacion y alquiler de los servicios</li>
                  <li>Profesionalismo en capacitacion de personal</li>
                  <li>Lealtad y Honestidad que aseguren la integridad de la empresa.</li>
                </ol>
							</div>
  					</div>
    			</div>
