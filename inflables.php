...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
 ...
 <section class="home-slider js-fullheight owl-carousel ftco-degree-bottom">
      <div class="slider-item js-fullheight" style="background-image: url(images/abb.jpg);">
      ...
      <div class="slider-item js-fullheight" style="background-image: url(images/abc3.jpg);">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-sm-7 ftco-animate text-center">
              <h1 class="mb-4">TUS MEJORES EVENTOS ENCUENTRALOS CON NOSOTROS</h1>
              <h2 class="subheading">"10 AÑOS NOS RESPALDAN"</h2>
            </div>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h3 class="subheading">Inflables</h3>
            <h2 class="mb-1">"EMPEÑADOS EN LA SONRRISA DE TUS PEQUEÑOS"</h2>
          </div>
        </div>
  ...
  $sdb=mysqli_select_db($con,$db)or die("la base de datos no existe");
    ...
    $consulta = "SELECT * FROM productos where Tipo= 'Inflable' ";
        ...
        <div class="row">
          <div class="col-lg-3 promo ftco-animate">
            <div class="text text-center">
             <iframe width="300" height="300" src="https://www.youtube.com/embed/gHsK8pgn_IY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>  
              <h2>INFLABLE MINION </h2>
              <h3 class="price"><span>Desde</span> $800 POR  5 HORAS</h3>
          ...
          <div class="col-lg-3 promo ftco-animate">
            <div class="text text-center">
              <iframe width="300" height="300" src="https://www.youtube.com/embed/0i8qXzC0wSg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

              


            <h2>INFLABLE COCODRILO</h2>
              <h3 class="price"><span>Desde</span> $850 POR 5 HORAS</h3>
            ...
            <div class="row no-gutters d-flex">
              <div class="col-md-4 ftco-animate">
                 <img src="images/ab.jpg" width="200" height="150">;
                  <div class="text">
                    <span class="price">Salon hipolito</span>
              ...
              <div class="col-md-4 ftco-animate">
                 <img src="images/ab.jpg" width="200" height="150">;
                  <div class="text">
                    <span class="price">Salon play rubert</span>
              ...
              <div class="col-md-4 ftco-animate">
                <img src="images/ab.jpg" width="200" height="150">;
                    <span class="price"> Jardin la finca</span>
