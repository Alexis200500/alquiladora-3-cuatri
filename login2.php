...
<body style="background-color: #FF530D;">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="Apellidos is required">
						...
						<input class="input100" type="text" name="appat" placeholder="Apellidos...">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Direccion is required">
						...
						<input class="input100" type="text" name="apmat" placeholder="Direccion...">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						...
						<input class="input100" type="text" name="repeatpass" placeholder="*************">
						<span class="focus-input100"></span>
					</div>
