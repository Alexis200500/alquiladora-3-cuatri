 ...
 <meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="css/estilos.css">
   <meta charset="utf-8">
    ...
    <script type="text/javascript" src="./modificar1.js"></script>
...
//$Ide=$_GET['id'];
 ...
 $consulta="SELECT * FROM productos where id_prod=$Ide ";
		...
		while ($row=mysqli_fetch_array($resultado)) {
				...
				<tr>
					<td>
						...
						<td><input type="text" class="tipo" value="'.$row[1].'"></td>
					<td><input type="text" class="color" value="'.$row[2].'"></td>
					<td><input type="text" class="dimension" value="'.$row[3].'"></td>
				  <td><input type="text" class="capacidad" value="'.$row[3].'"></td>
					<td><input type="text" class="presio" value="'.$row[5].'"></td>
					<td><input type="text" class="personaje" value="'.$row[6].'"></td>
          <td><input type="text" class="imagen" value="'.$row[7].'"></td>
