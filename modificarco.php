...
<p>.</p>
  ...
  <form action="ejemplo.php" method="get" style="background-color:#f3172b">
    ...
    <MARQUEE><h1 ><p style="color:#FFffff"; >MODIFICAR COMPRA </p> </h1></MARQUEE>
...
//$Ide=$_GET['id'];
 ...
 $consulta="SELECT * FROM compras ";
    ...
    ?>
      ...
      <tr>  
        <td  align="center"><h5><?php echo $columna['numeroventa'];?></h5></td>
        <td align="center"><h5><?php echo $columna['imagen'];?></h5></td>
        <td  align="center"><h5><?php echo $columna['nombre'];?></h5></td>
         <td  align="center"><h5><?php echo $columna['precio'];?></h5></td>
               <td  align="center"><h5><?php echo $columna['cantidad'];?></h5></td>
        <td  align="center"><h5><?php echo $columna['subtotal'];?></h5></td>
        
          <td  align="center"><a href="./modificar6.php?id=<?php echo $columna['numeroventa'];?>">Modificar</a></td>
