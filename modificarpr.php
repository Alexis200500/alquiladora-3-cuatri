...
<form action="ejemplo.php" method="get" style="background-color:#f3172b">
    ...
    <MARQUEE><h1 ><p style="color:#FFffff"; >MODIFICAR PRODUCTO</p> </h1></MARQUEE>
...
//$Ide=$_GET['id'];
 $consulta="SELECT * FROM productos ";
    ...
    ?>
      ...
      <tr>  
        <td  align="center"><h5><?php echo $columna['id_prod'];?></h5></td>
        <td align="center"><h5><?php echo $columna['Tipo'];?></h5></td>
        <td  align="center"><h5><?php echo $columna['Color'];?></h5></td>
         <td  align="center"><h5><?php echo $columna['Dimension'];?></h5></td>
               <td  align="center"><h5><?php echo $columna['capacidad'];?></h5></td>
        <td  align="center"><h5><?php echo $columna['presio'];?></h5></td>
        <td  align="center"><h5><?php echo $columna['personaje'];?></h5></td>
        <td  align="center"><<h5><?php echo $columna['imagen'];?></h5></td>
        
          <td  align="center"><a href="./modificar5.php?id=<?php echo $columna['id_prod'];?>">Modificar</a></td>
